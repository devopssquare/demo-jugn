...
exec {'build helloworld-deploy-seed':
  command => "java -jar /usr/share/jenkins/jenkins-cli.jar -i /var/lib/jenkins/.ssh/id_rsa -remoting -s http://localhost:8080/ build -s helloworld-deploy-seed",
...
exec {'build helloworld':
  command => "java -jar /usr/share/jenkins/jenkins-cli.jar -i /var/lib/jenkins/.ssh/id_rsa -remoting -s http://localhost:8080/ build -s helloworld-deploy",
