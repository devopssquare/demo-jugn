...
exec {'build helloworld-seed':
  command => "java -jar /usr/share/jenkins/jenkins-cli.jar -i /var/lib/jenkins/.ssh/id_rsa -remoting -s http://localhost:8080/ build -s helloworld-seed",
...
exec {'build helloworld':
  command => "java -jar /usr/share/jenkins/jenkins-cli.jar -i /var/lib/jenkins/.ssh/id_rsa -remoting -s http://localhost:8080/ build -s helloworld-install",
